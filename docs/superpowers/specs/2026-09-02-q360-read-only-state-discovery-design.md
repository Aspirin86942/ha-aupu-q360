...
> [!IMPORTANT]
> 本规格描述当前已部署的 v1 发现实现。其能力分类、实验状态机、报告格式和“原始 Shadow
> 不落盘”边界已由 [Q360 面板状态发现 v2 设计](./2026-09-03-q360-panel-state-discovery-v2-design.md)
> 取代。在 v2 完成实现并另行获准部署前，运行中的 v1 行为仍以本文件为准。
